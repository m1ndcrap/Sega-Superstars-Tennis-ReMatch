...
if(REXSDK_DIR)
    ...
    if(REXSDK_VERSION)
        ...
        find_package(rexglue 0.4.2 QUIET CONFIG)
    endif()
...
# Codegen target - run 'cmake --build . --target sst_rematch_codegen'
add_custom_target(sst_rematch_codegen
    COMMAND $<TARGET_FILE:rex::rexglue> codegen ${CMAKE_CURRENT_SOURCE_DIR}/config/sst_rematch_func.toml
    WORKING_DIRECTORY ${CMAKE_CURRENT_SOURCE_DIR}
    COMMENT "Generating recompiled code for sst_rematch"
    VERBATIM
)
